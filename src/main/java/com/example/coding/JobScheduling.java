...
//
//        Arrays.sort(endTime, compareForStartTime);
//        int sol = recurssion(startTime, endTime, profit, 1, 0, 0);
//        return sol;
//    }
//
//    private boolean compareForStartTime(int a, int b) {
//
//    }
//
//    int recurssion(int[] startTime, int[] endTime, int[] profit, int time, int index, int pro) {
//
...
//            sol = Integer.max(sol, recurssion(startTime, endTime, profit, endTime[index], index+1, pro+profit[index]));
//        }
//
//        sol = Integer.max(sol, recurssion(startTime, endTime, profit, time, index+1, pro));
//
//        return sol;
//    }
